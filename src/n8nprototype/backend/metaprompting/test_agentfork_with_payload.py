#!/usr/bin/env python3
"""
Test script for the agentfork webhook with a minimal payload
"""
import sys
import os
import json
...
def test_agentfork_webhook_with_payload():
    """Test webhook call to n8n agentfork workflow with a minimal payload"""
    ...
    try:
        # Make the POST request to the webhook with a timeout and payload
...
if __name__ == "__main__":
    test_agentfork_webhook_with_payload()
